...
exports.findAll = (req, res) => {
  ...
  Organisation.findAll({ where: condition })
    .then(data => {
      res.send(data);
    })
    .catch(err => {
...
exports.findAlllocation_code = (req, res) => {
    ...
    Organisation.findAll( { attributes: ['location_code'], group: ['location_code']})
      .then(data => {
        const datas = data.map((x) => x.location_code);
  ...
  exports.findAllorg_code = (req, res) => {
    ...
    Organisation.findAll( { attributes: ['org_code'], group: ['org_code']})
      .then(data => {
       const datas = data.map((x) => x.org_code);
        res.send(datas);
        // res.setHeader("Content-Type", "application/json");
        // res.json(data);
      })
  ...
  exports.findAllcontact_person = (req, res) => {
    ...
    Organisation.findAll( { attributes: ['contact_person'], group: ['contact_person']})
      .then(data => {
        const datas = data.map((x) => x.contact_person);
